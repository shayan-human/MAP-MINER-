...
```
git clone https://github.com/moazzam-07/google-maps-scraper.git
...
An example of the built .app can be seen in the releases section of this repository.

...
import (
	...
	"github.com/shayan-human/map-miner-private/tlmt/goposthog"
)
...
func Banner() {
	message1 := "🌍 Map Miner"
	message2 := "⭐ If you find this project useful, please star it on GitHub: https://github.com/shayan-human/map-miner-private"
	message3 := "🛠️ Professional Google Maps Data Extraction"
